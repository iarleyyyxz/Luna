...
// Estrutura para um vértice de linha (posição e cor)
struct LineVertex {
    glm::vec3 position; // Posição do vértice em 3D (Z pode ser 0.0f para 2D)
...
public:
    ...
    // NOVO: Desenha um retângulo preenchido (utiliza drawQuad com transformação)
    ...
    // A espessura da linha pode ser definida via glLineWidth, mas isso é obsoleto para linhas grossas,
    // ou desenhando um retângulo fino para simular espessura real.
